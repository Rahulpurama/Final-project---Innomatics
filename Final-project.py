...
st.title(":orange[AI Solution For Visually Impaired Individuals]")
...
def generate_image_description(image_data):
    prompt = "Describe the content of this image in detail. Assume the image represents a real-world scene."
    try:
...
if uploaded_file is not None:
    ...
    if col1.button("Real-Time Scene Understanding"):
    ...
    if col2.button("Text-to-Speech Conversion"):
    ...
    if col3.button("Object and Obstacle Detection"):
    ...
    if col4.button("Personalized Assistance"):
